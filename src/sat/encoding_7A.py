...
class Vlsi_sat(Vlsi_sat_abstract):
    """Class for solving the VLSI problem in SAT, using the encoding 7A.
    ...
    In particular, we want to break the following three simmetries:
    - Horizontal flip of the plate
    - Vertical flip of the plate
    - 180° flip of the plate 

    For ensuring these simmetry breaking constraints, the lexicographic ordering between lists of lists of boolean variables
