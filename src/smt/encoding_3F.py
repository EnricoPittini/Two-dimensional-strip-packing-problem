...
class Vlsi_smt(Vlsi_smt_abstract):
    """Class for solving the VLSI problem in SMT, using the encoding 3F.

    It inherits from the class `Vlsi_smt_abstract`.

    It is like the encoding 3E. We are imposing the "QF_IDL" logic.
    ...
    def __generate_encoding(self, l_max):
        """Generates the SMT encoding for the specific instance of the VLSI problem, according to the encoding 3F.
    ...
    def __optimize(self):
        """Solves the given VLSI instance, using the SAT encoding 3F.
