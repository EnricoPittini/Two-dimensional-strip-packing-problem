...
class Vlsi_smt(Vlsi_smt_abstract):
    """Class for solving the VLSI problem in SMT, using the encoding 3E.

    It inherits from the class `Vlsi_smt_abstract`.

    It is exactly like the encoding 3D. SMT variables 'coordX_i', 'coordY_i' and 'l'. Binary search optimization procedure.
    ...
    This is a more specific logic with respect to the encoding 3D.
    ...
    def __generate_encoding(self, l_max):
        """Generates the SMT encoding for the specific instance of the VLSI problem, according to the encoding 3E.
    ...
    def __optimize(self):
        """Solves the given VLSI instance, using the SAT encoding 3E.
