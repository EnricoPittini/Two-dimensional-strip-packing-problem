...
class Vlsi_sat(Vlsi_sat_abstract):
    ...
    The LINEAR SEARCH is still used, but now searching from the bottom instead of the top. 
    ...
    We inject into the solver new constraints, ensuring that the actual length of the plate is smaller or equal than 'l'. 
