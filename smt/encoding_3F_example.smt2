; EXAMPLE OF SMT-LIB FILE, ACCORDING TO THE ENCODING 3F
...
; $ z3 sm/encoding_3F_example.smt2
; OUTPUT
; sat
; ((coordX_0 0)
;  (coordY_0 0)
...
(assert (or (<= (- coordX_0 coordX_1) (- 2)) (<= (- coordX_1 coordX_0) (- 3)) (<= (- coordY_0 coordY_1) (- 2)) (<= (- coordY_1 coordY_0) (- 3))))
